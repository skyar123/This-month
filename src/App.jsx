...
function Card({ title, children, accent = "border-l-emerald-500", icon }) {
  return (
    <div className={`bg-white rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.07)] border-l-[6px] ${accent} p-4 mb-4 hover:shadow-lg transition-shadow`}>
...
function SectionHeader({ children, emoji }) {
  return (
    <div className="flex items-center gap-3 mb-4 mt-6">
      ...
      <h2 className="text-xl font-medium text-[#1a2520] tracking-tight font-fraunces">{children}</h2>
    </div>
  );
}
